...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            ...
            <h4 class="header-title m-t-0 text-center">Edit Category</h4>

            {!! Form::open(['action' => ['CategoryController@update', $category->id], 'method' => 'POST', 'enctype' => 'multipart/form-data','files'=>'true']) !!}
            {{method_field('PUT')}}
            {{ csrf_field() }}
                    ...
                    <div class="p-20">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" parsley-trigger="change" required
                                   placeholder="Category Name" class="form-control" id="name" value="{{$category->name}}">
                        </div>
