    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                ...
                <h4 class="header-title m-t-0 text-center">Add Group</h4>

                {!! Form::open(['action' => 'GroupController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data','files'=>'true']) !!}
                        ...
                        <div class="p-20">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" parsley-trigger="change" required
                                       placeholder="Group Name" class="form-control" id="name">
                            </div>
